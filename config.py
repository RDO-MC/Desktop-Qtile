...
keys = [
    ...
    Key([mod], "m", lazy.spawn("~/.config/cmatrix/run_cmatrix.sh"), desc="Run cmatrix with custom settings"),
     #nuevo grupo de ventanas 
    Key([mod], "p", lazy.function(lambda qtile: qtile.cmd_addgroup())),
   ...
   ##captura de pantalla 
   Key([mod], "a", lazy.spawn("scrot '/home/acdc/imagenes/screenshot_%%Y-%%m-%%d_%%H-%%M-%%S.png'")),
...
autostart = [
    "setxkbmap es",
    "feh --bg-fill /home/acdc/.config/qtile/wallpapers/woman.jpg",
    "xcompmgr &",
    "picom &",
    "nm-applet &",
    "pulseaudio --start",
